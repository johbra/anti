...
return [(function (){var pred__17053 = cljs.core.instance_QMARK_;
var expr__17054 = reactive_val;
if(cljs.core.truth_(pred__17053.call(null,reagent.ratom.RAtom,expr__17054))){
return "ra";
} else {
if(cljs.core.truth_(pred__17053.call(null,reagent.ratom.RCursor,expr__17054))){
return "rc";
} else {
if(cljs.core.truth_(pred__17053.call(null,reagent.ratom.Reaction,expr__17054))){
return "rx";
} else {
if(cljs.core.truth_(pred__17053.call(null,reagent.ratom.Track,expr__17054))){
return "tr";
} else {
return "other";
}
