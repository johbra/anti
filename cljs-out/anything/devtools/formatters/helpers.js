...
var G__25245 = devtools.prefs.pref.call(null,v);
v = G__25245;
continue;
} else {
return v;
...
}catch (e25246){var _e__24508__auto__ = e25246;
return false;
}})();
...
}catch (e25248){var _e__24508__auto__ = e25248;
return false;
}})();
...
}catch (e25250){var _e__24508__auto__ = e25250;
return false;
}}
}
});
...
var vec__25252 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25252,(0),null);
var name = cljs.core.nth.call(null,vec__25252,(1),null);
...
return cljs.core.some.call(null,(function (p1__25255_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25255_SHARP_);
}),template);
});
