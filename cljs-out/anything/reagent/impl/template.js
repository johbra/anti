...
var G__16905 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__16905,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__16906__delegate = function (args){
...
return G__16906__delegate.call(this,args);};
...
return G__16906__delegate(args);
});
...
var G__16909 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__16909,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__16910__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__16911__i < G__16911__a.length) {G__16911__a[G__16911__i] = arguments[G__16911__i + 0]; ++G__16911__i;}
  args = new cljs.core.IndexedSeq(G__16911__a,0,null);
} 
return G__16910__delegate.call(this,args);};
G__16910.cljs$lang$maxFixedArity = 0;
G__16910.cljs$lang$applyTo = (function (arglist__16912){
var args = cljs.core.seq(arglist__16912);
return G__16910__delegate(args);
});
...
var G__16913 = props;
var G__16913__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__16913,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16913);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16913__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__16914 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16914,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__16914;
}
})(),id_class);
...
var G__16915 = (cljs.core.count.call(null,argv) - first_child);
switch (G__16915) {
case (0):
...
var vec__16917 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__16917,(0),null);
var id = cljs.core.nth.call(null,vec__16917,(1),null);
var className = cljs.core.nth.call(null,vec__16917,(2),null);
...
var temp__5829__auto___16920 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___16920 == null)){
} else {
var key_16921 = temp__5829__auto___16920;
(jsprops.key = key_16921);
}
...
var temp__5829__auto___16922 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5829__auto___16922 == null)){
} else {
var key_16923 = temp__5829__auto___16922;
(jsprops.key = key_16923);
}
...
var temp__5829__auto___16924 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5829__auto___16924 == null)){
} else {
var key_16925 = temp__5829__auto___16924;
(jsprops.key = key_16925);
}
...
var temp__5829__auto___16926 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___16926 == null)){
} else {
var key_16927 = temp__5829__auto___16926;
(jsprops.key = key_16927);
}
...
var temp__5829__auto___16928 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5829__auto___16928 == null)){
} else {
var key_16929 = temp__5829__auto___16928;
(jsprops.key = key_16929);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__16930_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__16930_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__16931 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__16931,(0),null);
var derefed = cljs.core.nth.call(null,vec__16931,(1),null);
...
break;
default:
var G__16936 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__16937 = compiler;
v = G__16936;
compiler = G__16937;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template16941 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template16941 = (function (opts,id,fn_to_element,meta16942){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template16941.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16943,meta16942__$1){
var self__ = this;
var _16943__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template16941(self__.opts,self__.id,self__.fn_to_element,meta16942__$1));
}));

(reagent.impl.template.t_reagent$impl$template16941.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16943){
var self__ = this;
var _16943__$1 = this;
return self__.meta16942;
}));

(reagent.impl.template.t_reagent$impl$template16941.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template16941.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template16941.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template16941.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template16941.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta16942","meta16942",-145868831,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template16941.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template16941.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template16941");

(reagent.impl.template.t_reagent$impl$template16941.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template16941");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template16941.
 */
reagent.impl.template.__GT_t_reagent$impl$template16941 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template16941(opts__$1,id__$1,fn_to_element__$1,meta16942){
return (new reagent.impl.template.t_reagent$impl$template16941(opts__$1,id__$1,fn_to_element__$1,meta16942));
});

}

return (new reagent.impl.template.t_reagent$impl$template16941(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
