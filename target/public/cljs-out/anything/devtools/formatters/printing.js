...
var len__5769__auto___25292 = arguments.length;
var i__5770__auto___25293 = (0);
while(true){
if((i__5770__auto___25293 < len__5769__auto___25292)){
args__5775__auto__.push((arguments[i__5770__auto___25293]));

var G__25294 = (i__5770__auto___25293 + (1));
i__5770__auto___25293 = G__25294;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25289){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25290,G__25291,seq25289__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25295_SHARP_){
return (!((cljs.core.meta.call(null,p1__25295_SHARP_) == null)));
})))){
...
var map__25296 = opts;
var map__25296__$1 = cljs.core.__destructure_map.call(null,map__25296);
var markup_db = cljs.core.get.call(null,map__25296__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25297){var _e__24516__auto__ = e25297;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e25299){var _e__24516__auto__ = e25299;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25301 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25302 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25302);
...
var markup_db = cljs.core.get.call(null,map__25303__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25301);
}});
...
var temp__5823__auto___25307 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5823__auto___25307)){
var managed_print_level_25308 = temp__5823__auto___25307;
var _STAR_print_level_STAR__orig_val__25305_25309 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25306_25310 = managed_print_level_25308;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25306_25310);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__25304_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25304_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25305_25309);
}} else {
job_fn.call(null);
}
