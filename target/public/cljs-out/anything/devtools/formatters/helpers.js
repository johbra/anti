...
var G__25251 = devtools.prefs.pref.call(null,v);
v = G__25251;
continue;
} else {
return v;
...
}catch (e25252){var _e__24514__auto__ = e25252;
return false;
}})();
...
}catch (e25254){var _e__24514__auto__ = e25254;
return false;
}})();
...
}catch (e25256){var _e__24514__auto__ = e25256;
return false;
}}
}
});
...
var vec__25258 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25258,(0),null);
var name = cljs.core.nth.call(null,vec__25258,(1),null);
...
return cljs.core.some.call(null,(function (p1__25261_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25261_SHARP_);
}),template);
});
