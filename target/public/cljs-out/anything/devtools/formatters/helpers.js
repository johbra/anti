...
var G__25253 = devtools.prefs.pref.call(null,v);
v = G__25253;
continue;
} else {
return v;
...
}catch (e25254){var _e__24516__auto__ = e25254;
return false;
}})();
...
}catch (e25256){var _e__24516__auto__ = e25256;
return false;
}})();
...
}catch (e25258){var _e__24516__auto__ = e25258;
return false;
}}
}
});
...
var vec__25260 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25260,(0),null);
var name = cljs.core.nth.call(null,vec__25260,(1),null);
...
return cljs.core.some.call(null,(function (p1__25263_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25263_SHARP_);
}),template);
});
