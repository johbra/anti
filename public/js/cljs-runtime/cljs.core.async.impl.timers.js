...
var i_18105 = (0);
while(true){
if((i_18105 < arr.length)){
(arr[i_18105] = null);

var G__18106 = (i_18105 + (1));
i_18105 = G__18106;
continue;
} else {
}
...
var i_18122 = (self__.level + (1));
while(true){
if((i_18122 <= (new_level + (1)))){
(update[i_18122] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_18124 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_18124[i]));
} else {
x__$2.forward.push((((i < links_18124.length))?(links_18124[i]):null));
}

if((i < links_18124.length)){
(links_18124[i] = x__$2);
} else {
links_18124.push(x__$2);
}
...
var i_18128 = (0);
while(true){
if((i_18128 <= self__.level)){
var links_18129 = (update[i_18128]).forward;
if((x__$1 === (((i_18128 < links_18129.length))?(links_18129[i_18128]):null))){
(links_18129[i_18128] = (x__$1.forward[i_18128]));

var G__18130 = (i_18128 + (1));
i_18128 = G__18130;
continue;
} else {
var G__18131 = (i_18128 + (1));
i_18128 = G__18131;
continue;
}
} else {
...
var G__18139 = nx;
var G__18140 = (level__$1 - (1));
x = G__18139;
level__$1 = G__18140;
continue;
} else {
var G__18141 = x;
var G__18142 = (level__$1 - (1));
x = G__18141;
level__$1 = G__18142;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__18148 = nx;
var G__18149 = (level__$1 - (1));
x = G__18148;
level__$1 = G__18149;
continue;
} else {
var G__18150 = x;
var G__18151 = (level__$1 - (1));
x = G__18150;
level__$1 = G__18151;
continue;
}
