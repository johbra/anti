...
var periods__$1 = cljs.core.vec((function (){var G__16333 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16332_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__16332_SHARP_,(0),(3));
}),G__16333);
} else {
return G__16333;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__16341){
var vec__16342 = p__16341;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16342,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16342,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__16345 = pattern;
switch (G__16345) {
case "S":
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16345))));
...
return p1__16347_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__16348_SHARP_){
return p1__16348_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__16349_SHARP_){
return p1__16349_SHARP_.getMinutes();
});
...
return p1__16351_SHARP_.getHours();
});

break;
case "day":
return (function (p1__16352_SHARP_){
return p1__16352_SHARP_.getDate();
});

break;
case "month":
return (function (p1__16353_SHARP_){
return p1__16353_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__16354_SHARP_){
return p1__16354_SHARP_.getYear();
});

break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16355__$1))));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__16356){
...
break;
case "ordinal-suffix":
var vec__16361 = (function (){var G__16367 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__16367) : syntax_list.call(null,G__16367));
})();
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16360__$1))));
...
var d = value;
var G__16371 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__16374;
var more = seq__16373__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__16383;
var more__$1 = seq__16382__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__16384 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16384,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16384,(1),null);
var G__16417 = d__$3;
var G__16418 = more__$1;
var G__16419 = s__$3;
d__$1 = G__16417;
G__16371__$1 = G__16418;
s__$1 = G__16419;
continue;
}
break;
