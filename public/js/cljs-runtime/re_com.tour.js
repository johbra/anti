...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__18519_SHARP_,p2__18520_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__18519_SHARP_,p2__18520_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5628__auto__ = (function re_com$tour$initialise_tour_$_iter__18540(s__18541){
return (new cljs.core.LazySeq(null,(function (){
var s__18541__$1 = s__18541;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__18541__$1);
if(temp__5823__auto__){
var s__18541__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__18541__$2)){
var c__5626__auto__ = cljs.core.chunk_first(s__18541__$2);
var size__5627__auto__ = cljs.core.count(c__5626__auto__);
var b__18543 = cljs.core.chunk_buffer(size__5627__auto__);
if((function (){var i__18542 = (0);
while(true){
if((i__18542 < size__5627__auto__)){
var step = cljs.core._nth(c__5626__auto__,i__18542);
cljs.core.chunk_append(b__18543,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__18625 = (i__18542 + (1));
i__18542 = G__18625;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18543),re_com$tour$initialise_tour_$_iter__18540(cljs.core.chunk_rest(s__18541__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18543),null);
}
} else {
var step = cljs.core.first(s__18541__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__18540(cljs.core.rest(s__18541__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__18606 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__18606.cljs$core$IFn$_invoke$arity$1 ? fexpr__18606.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__18606.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__18613 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__18613.cljs$core$IFn$_invoke$arity$1 ? fexpr__18613.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__18613.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__18614 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__18614.cljs$core$IFn$_invoke$arity$1 ? fexpr__18614.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__18614.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__18616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__18616.cljs$core$IFn$_invoke$arity$1 ? fexpr__18616.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__18616.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__18620 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__18620.cljs$core$IFn$_invoke$arity$1 ? fexpr__18620.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__18620.call(null,tour));
})(),true);
} else {
return null;
}
